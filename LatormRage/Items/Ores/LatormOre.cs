...
{
	public class LatormOre : ModItem //"LatormOre" its the item name, change with your's.
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Latorm Ore");
			Tooltip.SetDefault("A heavy metal");
		}
		public override void SetDefaults()
		{
			...
			item.createTile = mod.TileType("LatormOreTexture"); //remember dont put here "LatormOre" because its the item, you need to put here the texture "TileExample1", that will appear when you create a world.
		}
	}
}
