...
{
    public class BulletExampleSprite : ModProjectile //the class of the projectile
    {
        public override void SetDefaults()
        {
            ...
            projectile.aiStyle = 1; //projectile moves in a straight line
            projectile.friendly  = true; //player projectile
            projectile.ranged = true; //ranged projectile
            projectile.timeLeft = 300; //lasts for 600 frames/ticks. Terraria runs at 60FPS, so it lasts 10 seconds.
            aiType = ProjectileID.CrystalBullet; //This clones the exact AI of the vanilla projectile Bullet.
        }
